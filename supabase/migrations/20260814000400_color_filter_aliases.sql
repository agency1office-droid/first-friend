  ...
  where a.active = true
    ...
    and (
      ...
      or case lower(trim(p_color))
        when '흰색' then a.color_search like any (array['%흰색%','%흰%','%백색%','%백%','%화이트%','%하얀%','%아이보리%'])
        when '검정' then a.color_search like any (array['%검정%','%검은색%','%검은%','%검%','%흑색%','%흑%','%블랙%','%까만색%'])
        when '갈색' then a.color_search like any (array['%갈색%','%갈색계열%','%갈%','%밤색%','%브라운%','%초콜릿%','%쵸콜릿%','%흑갈색%','%황갈색%','%금갈색%','%연갈색%','%암갈색%','%갈백%','%갈흑%'])
        when '황색' then a.color_search like any (array['%황색%','%황색계열%','%황토색%','%황토%','%노랑%','%노란색%','%노%','%옐로우%','%레몬색%','%크림색%','%금색%','%금갈색%','%황갈색%','%옅은 황색%','%엷은 황갈색%','%붉고 엷은 황갈색%','%주황%','%겨자색%','%살구색%','%빨간색%','%베이지%','%탄%','%고동색말단%'])
        when '회색' then a.color_search like any (array['%회색%','%회%','%그레이%','%잿빛%','%은색%','%실버%','%흰회%','%회백%','%회갈%'])
