...
export const animals: Animal[] = [
  {
    id: "bomi", name: "보미", species: "고양이", age: "3살 추정", ageGroup: "어른 친구", sex: "여아", region: "서울 마포구", shelter: "햇살 보호소", source: "인증 보호소", updated: "2026. 8. 8.",
  ...
  {
    id: "dubu", name: "두부", species: "강아지", age: "5살 추정", ageGroup: "어른 친구", sex: "남아", region: "부산 수영구", shelter: "바다 임시보호", source: "개인 임시보호", updated: "2026. 8. 7.",
  ...
  {
    id: "toto", name: "토토", species: "고양이", age: "8개월 추정", ageGroup: "어린 친구", sex: "남아", region: "대전 유성구", shelter: "유성 동물보호센터", source: "공공 데이터", updated: "2026. 8. 9.",
  ...
  {
    id: "maru", name: "마루", species: "강아지", age: "7살 추정", ageGroup: "어른 친구", sex: "여아", region: "제주 제주시", shelter: "곶자왈 쉼터", source: "인증 보호소", updated: "2026. 8. 6.",
