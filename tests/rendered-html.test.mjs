...
test("uses a contextual animal detail topbar", async () => {
  ...
  assert.match(readinessQuiz, /if \(phase === "intro"\) \{ setSpecies\(null\); setAnswers\(\{\}\); setFeedbackAnswer\(null\); setStep\(0\); setPhase\("species"\); return; \}/);
  assert.match(readinessQuiz, /if \(phase === "questions" && feedbackAnswer !== null\) \{ setFeedbackAnswer\(null\); setPendingAnswer\(null\); return; \}/);
