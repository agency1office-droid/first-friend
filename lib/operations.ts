...
export const operationResources = {
  ...
  posts: { label: "이야기 관리", table: "posts", title: "title", search: "title", statuses: ["draft","published","deleted"], pending: [], fields: "id,member_id,category,title,body,status,image_keys,revision,reaction_count,hidden,created_at" },
...
export const operationLabels: Record<string, string> = {
  ...
  submitted: "접수", review: "검토 대기", consulting: "상담 중", approved: "승인", rejected: "반려", handover: "인계 중", completed: "완료", withdrawn: "철회", return_support: "돌봄 지원", published: "공개", closed: "종료", draft: "임시저장", deleted: "삭제됨", revision: "수정 버전", reaction_count: "응원 수", verified: "인증 완료", connected: "연결 중", resolved: "해결", accepted: "수용", open: "진행 중", settled: "정산 완료",
