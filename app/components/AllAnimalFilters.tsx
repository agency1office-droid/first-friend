...
import { IconCheckmarkScaleLine, IconChevronLeftLine, IconChevronDownLine, IconPawprintLine, IconSlider2HorizontalLine, IconXmarkLine } from "@karrotmarket/react-monochrome-icon";
