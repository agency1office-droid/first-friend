...
export default async function Page({
  ...
  // 담당자 인증(verified)이 끝난 프로필만 공공데이터의 이름·지역을 대체합니다.
  if (profile?.verified && profile.name) shelter.name = String(profile.name);
  if (profile?.verified && profile.region) region = String(profile.region);
