...
export function AppChrome({children}:{children:React.ReactNode}){
  ...
  if(path.startsWith("/quiz/")||path==="/find/worldcup") return <div className="ff-quiz-shell" data-route-path={path}><main className="ff-main" id="main-content" tabIndex={-1}>{children}</main><LoginPrompt/></div>;
