    ...
    <section className="ff-adoption-planning" aria-labelledby="adoption-planning-title">
      ...
      <div className="ff-adoption-planning-list">
        <Link className="ff-adoption-planning-row" href="/quiz/care-readiness">
          <span className="ff-adoption-planning-step" aria-hidden="true">1</span>
        ...
        <Link className="ff-adoption-planning-row" href="/quiz/adoption-prep">
          <span className="ff-adoption-planning-step" aria-hidden="true">2</span>
        ...
        <button className="ff-pet-knowledge-trigger" type="button" onClick={() => setKnowledgeQuizOpen(true)}><span className="ff-adoption-planning-step" aria-hidden="true">4</span><span className="ff-adoption-planning-row-copy"><strong>반려동물 상식 퀴즈</strong></span><IconArrowUpRightLine aria-hidden /></button>
      </div>
