...
export function LostAnimalActions() {
  return <div className="ff-sticky-actions ff-lost-sticky-actions">
    ...
    <ActionButton asChild variant="neutralWeak"><Link href="https://www.animal.go.kr/front/awtis/loss/findFrm.do?menuNo=1000000054" target="_blank" rel="noreferrer">온라인으로 신고하기</Link></ActionButton>
  </div>;
}
