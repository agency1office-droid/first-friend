import type{Metadata}from"next";import{WorldCupFinder}from"../../components/WorldCupFinder";import{getAuthenticatedMember}from"../../chatgpt-auth";export const metadata:Metadata={title:"첫 친구 이상형 월드컵",openGraph:{title:"첫 친구 이상형 월드컵",type:"website",images:["/og.png"]}};
