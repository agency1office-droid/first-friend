...
export function SimpleOptionSheet({ triggerLabel, title, description, value, options, active, onChange, onReset }: { triggerLabel?: string; title: string; description: string; value: string; options: readonly (readonly [string, string, string])[]; active: boolean; onChange: (value: string) => void; onReset: () => void }) {
