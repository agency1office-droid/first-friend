...
export default async function MyPage() {
  ...
  return <div className="ff-page">
    ...
    <section className="ff-section"><h2 className="ff-section-title" style={{marginBottom:10}}>가족·상담·도움 관리</h2><div className="ff-service-grid"><a href="/mypage/family"><IconHeartLine/><strong>가족 상의</strong><span>함께 본 친구와 의견</span></a><a href="/mypage/messages"><IconArticleLine/><strong>메시지함</strong><span>입양 상담과 인계 기록</span></a><a href="/stories/manage"><IconArticleLine/><strong>글 관리</strong><span>수정·삭제·공유</span></a><a href="/mypage/help"><IconHousePlusLine/><strong>도움 기록</strong><span>후원·굿즈·물품 상태</span></a><a href="/shelters/manage"><IconGearLine/><strong>보호소 운영</strong><span>소식·봉사·필요 물품</span></a></div></section>
  </div>;
}
